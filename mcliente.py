...
if __name__ == "__main__":
    ...
    server.bind((host, port)) #indicamos el puerto de escucha
    ...
    try:
        while True:
            conn, addr = server.accept() #espera conexion entrante
            '''
            El método .accept() devuelve un objeto soket que representa 
            la conexion del cliente  (conn) y una tupla que contiene el 
            host y puerto (addr) de dicha conexion
            '''
